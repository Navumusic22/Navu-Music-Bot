...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name =  "@Awesome_blossom_music_bot"
    usar = user
    wew = usar.id
    try:
           ...
           for administrator in administrators:
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  "<b>@A_B_Music_Assistant userbot joined your chat</b>",
                              )
                              ...
                              await lel.edit(
                                  ...
                                  "\n\nOr manually add @A_B_Music_Assistant to your Group and try again</b>",
                              )
                              pass
    try:
        chatdetails = await USER.get_chat(chid)
        ...
        await lel.edit(
            f"<i> @A_B_Music_Assistant Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
        return     
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        photo="final.png",
        reply_markup=keyboard,
        caption="✯Awesome Blossom Music✯▶️ **Playing** here the song requested by {} 😜".format(
...
async def deezer(client: Client, message_: Message):
    ...
    try:
        ...
        user.first_name =  "Awesome Blossom Music Assistant"
    usar = user
    wew = usar.id
    try:
        #chatdetails = await USER.get_chat(chid)
           ...
           for administrator in administrators:
                      if administrator == message_.from_user.id:  
                          ...
                          try:
                              ...
                              await lel.edit(
                                  "<b>@A_B_Music_Assistant userbot joined your chat | made by Navu</b>",
                              )
    ...
    try:
        ...
        await lel.edit(
            f"<i>Looks like @A_B_Music_Assistant Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
        return                            
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        appendable = [s_name, r_by, loc]
        qeue.append(appendable)
        await res.edit_text(f"✯Awesome Blossom Music✯=#️⃣ Queued at position {position}")
    else:
        await res.edit_text("✯Awesome Blossom Music✯=▶️ Playing.....")
...
async def jiosaavn(client: Client, message_: Message):
           ...
           for administrator in administrators:
                      if administrator == message_.from_user.id:  
                          ...
                          try:
                              ...
                              await USER.send_message(message_.chat.id,"I joined this group for playing music in VC")
                              await lel.edit(
                                  "<b>@A_B_Music_Assistant helper userbot joined your chat</b>",
                              )
    ...
    try:
        ...
        await lel.edit(
            "<i> @A_B_Music_Assistant helper Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
        return     
    requested_by = message_.from_user.first_name
    chat_id=message_.chat.id
         ...
         [   
             ...
             [
               InlineKeyboardButton(
                   ...
                   url='https://t.me/navu_music_support')
             ],
             [       
               InlineKeyboardButton(
                   text="❌ Close",
    ...
    if message_.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        m = await client.send_photo(
            ...
            reply_markup=keyboard,
            photo="final.png",
            caption=f"✯Awesome Blossom Music✯=#️⃣ Queued at position {position}",
